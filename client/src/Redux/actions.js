...
export const ADD=(state,countt,idd,imagee,namee)=>{
    ...
    return (dispatch)=>{
        ...
        if (Cookies.get('user')) {
            ...
            fetch('http://localhost:3000/cart?q=add',{headers:{ 'Accept': 'application/json','Content-Type': 'application/json'},
...
export const DECR=(keyy)=>{
    return (dispatch)=>{
        ...
        fetch('http://localhost:3000/cart?q=delete',{headers:{ 'Accept': 'application/json','Content-Type': 'application/json'},
...
export const LOGIN=(state)=>{
    return (dispatch)=>{
        ...
        fetch('http://localhost:3000/cart?q=login',{headers:{ 'Accept': 'application/json','Content-Type': 'application/json'},
